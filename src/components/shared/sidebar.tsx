...
export default function AppSidebar() {
  ...
  return (
    <div className="flex flex-col items-center py-4 gap-6 bg-zinc-950 h-full w-24 border-r border-zinc-800">
      <button
      ...
      <Popover>
        ...
        <PopoverContent align="start"  >
          <PopoverHeader>
            <PopoverTitle className="font-sans-bold ">{user.email}</PopoverTitle>
          </PopoverHeader>
          <div className="w-full h-auto py-1 flex items-center hover:bg-gray-300 rounded-md">
           <p onClick={logout}  className="w-full text-red-500 text-md font-sans-bold   rounded-md cursor-pointer   border-none  text-center ">Tizimdan chiqish</p>
          </div>
        </PopoverContent>
      </Popover>
    </div>
